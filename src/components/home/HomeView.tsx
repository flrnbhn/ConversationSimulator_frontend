...
export const HomeView = () => {
    ...
    const highscoreExplanation = "Zeig dein Können im Highscore-Spiel! Hier führst du so lange eine Konversation, bis du einen Fehler machst. Bist du bereit, dich mit anderen zu messen und deinen Platz an der Spitze zu sichern?";
